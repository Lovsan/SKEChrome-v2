function sktools_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
sktools_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				sktools_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
sktools_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
sktools_xmlhttpRequester.prototype.setupRequestEvent =
